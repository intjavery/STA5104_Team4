...
%let PATH = ~/ASS04/;
LIBNAME ASS04 "/home/u63737872/ASS04";
...
DATA work.employees;
	SET ASS04.SALES;
	KEEP Full_Name Hire_Date Yrs2012;
...
PROC PRINT DATA=work.employees LABEL;
   VAR Full_Name Hire_Date Yrs2012;
RUN;
...
DATA work.increase;
    ...
    IF Emp_Hire_Date > '01JUL2006'd AND Raise > 3000;
    
    FORMAT Emp_Hire_Date date9. Raise dollar9.2;
RUN;

PROC PRINT DATA=work.increase SPLIT='';
    VAR Employee_ID Emp_Hire_Date Job_Title Salary Raise;
    TITLE 'Employees with More Than $3000 Raise Hired After July 1, 2006';
RUN;
